...
public class Cactus extends EnhancedMapTile {
    private GameObject BloodObject;
    private Frame BloodFrame;

    /** Uses Resources/barrel.png */
    public Cactus(Point location) {
        this(location, "large_cactus.png");
    }

    public Cactus(Point location, String imageFileName) {
        super(
            location.x,
            location.y,
