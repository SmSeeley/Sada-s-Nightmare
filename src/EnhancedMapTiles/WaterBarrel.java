...
public class WaterBarrel extends EnhancedMapTile {
    private GameObject barrelObject;
    private Frame barrelFrame;

    /** Uses Resources/barrel.png */
    public WaterBarrel(Point location) {
        this(location, "waterbarrel.png");
    }

    public WaterBarrel(Point location, String imageFileName) {
        super(
            location.x,
            location.y,
