 ...
 */
public class SandDoor extends EnhancedMapTile {
    ...
    public SandDoor(Point location) {
        super(location.x, location.y,
                new SpriteSheet(ImageLoader.load("Sand_Door2.png"), 16, 32),
    ...
    public SandDoor toMap(String mapName, int spawnTileX, int spawnTileY) {
    ...
    public SandDoor withTileSizePixels(int tileW, int tileH) {
        this.tileW = tileW;
        this.tileH = tileH;
        return this;
    }
