 ...
 */
public class FireDoor extends EnhancedMapTile {
    ...
    public FireDoor(Point location) {
        super(location.x, location.y,
                new SpriteSheet(ImageLoader.load("Fire_Door.png"), 16, 32),
    ...
    public FireDoor toMap(String mapName, int spawnTileX, int spawnTileY) {
    ...
    public FireDoor withTileSizePixels(int tileW, int tileH) {
        this.tileW = tileW;
        this.tileH = tileH;
        return this;
    }
