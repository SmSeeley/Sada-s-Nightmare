...
public class LeftFacingDoor extends Door {
    public LeftFacingDoor(Point location) {
        super(location);
    }
    ...
    protected GameObject loadBottomLayer(SpriteSheet ignoredSheet) {
        ...
        SpriteSheet closedSheet = new SpriteSheet(ImageLoader.load("door_close_left.png"), 32, 16);
...
public class LeftFacingDoor extends EnhancedMapTile {
    ...
    public LeftFacingDoor(Point location) {
        ...
        super(location.x, location.y,
              new SpriteSheet(ImageLoader.load("door_close_left.png"), 32, 16),
