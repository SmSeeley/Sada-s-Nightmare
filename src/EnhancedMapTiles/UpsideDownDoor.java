...
public class UpsideDownDoor extends EnhancedMapTile {
    ...
    public UpsideDownDoor(Point location) {
        ...
        super(location.x, location.y,
              new SpriteSheet(ImageLoader.load("door_close_down.png"), 16, 32),
    ...
    protected GameObject loadBottomLayer(SpriteSheet sheet) {
        ...
        closedFrame = new FrameBuilder(sheet.getSubImage(0, 0))
                .withScale(3)
                .withBounds(0, 0, 32, 32) // collide on lower half
                .build();
        ...
        // Lower sprite 16px so it sits on ground
